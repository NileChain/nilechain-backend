"""Deterministic NileChain knowledge seed — mirrors ChromaKnowledgeSeeder.cs."""

from __future__ import annotations

# Keep IDs/metadata aligned with backend/NileChain.AI/RAG/ChromaKnowledgeSeeder.cs
_ITEMS: list[tuple[str, str, str]] = [
    (
        "Quality Standards",
        "Egyptian Wheat Grade A Standards",
    ...
    (
        "Quality Standards",
        "Tomato Processing Grade Requirements",
    ...
    (
        "Quality Standards",
        "Rice Moisture and Broken Grain Limits",
    ...
    (
        "Contract Templates",
        "Standard Forward Supply Contract Clauses",
    ...
    (
        "Contract Templates",
        "Payment Terms for Agri Supply Deals",
    ...
    (
        "Contract Templates",
        "Rejection and Reinspection Clause",
    ...
    (
        "Agri Science",
        "Wheat Irrigation Scheduling in the Delta",
    ...
    (
        "Agri Science",
        "Potato Tuber Initiation Best Practices",
    ...
    (
        "Agri Science",
        "Corn Nitrogen Timing for Nile Valley",
    ...
    (
        "Market Intelligence",
        "Seasonal Wheat Price Patterns Egypt",
    ...
    (
        "Market Intelligence",
        "Tomato Price Volatility Drivers",
    ...
    (
        ...
        "Agricultural Quarantine Export Rules",
    ...
    (
        "Egyptian Regulations",
        "Farm Land Documentation Basics",
    ...
    (
        "Egyptian Regulations",
        "Food Factory Licensing Overview",
    ...
    (
        "Food Safety",
        "HACCP Critical Control Points for Packhouses",
    ...
    (
        "Food Safety",
        "Aflatoxin Control in Corn Storage",
    ...
    (
        "Food Safety",
        "Hygiene for Fresh Produce Handling",
    ...
    (
        "Export Standards",
        "GlobalGAP for Egyptian Growers",
    ...
    (
        "Export Standards",
        "EU Entry Requirements for Fresh Produce",
    ...
    (
        "Soil",
        "Reclaimed Desert Sand Amendments",
    ...
    (
        "Pests",
        "Wheat Aphid Monitoring Thresholds",
    ...
    (
        "Pests",
        "Tomato Tuta Absoluta Management",
    ...
    (
        "Pests",
        "Rice Stem Borer Cultural Controls",
...
def build_seed_payload(collection_name: str = "nilechain_knowledge") -> dict:
    ids: list[str] = []
    documents: list[str] = []
    metadatas: list[dict] = []

    for i, (category, title, body) in enumerate(_ITEMS):
        ids.append(f"seed-doc-{i:03d}")
